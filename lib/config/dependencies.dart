...
List<SingleChildWidget> get remoteProviders {
  return [
    ...
    Provider(create: (_)=>RemoteDb()),
    Provider(create: (context)=>AuthRepoRemote(preferencesService: context.read(), authClient: context.read(),remoteDb: context.read())),
    Provider(create: (context)=>ChatRepoRemote(chapClient: context.read(), sqliteDb: context.read(),remoteDb: context.read())),
